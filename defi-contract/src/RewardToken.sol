...
/**
 * @title RewardToken (DRT - DeFi Reward Token)
 * @dev ERC20 Token - 任何地址可以自行 mint，每个地址最多 mint 100,000 枚
 * @notice 教学用途：方便学员自行获取测试代币
 */
contract RewardToken {
    string public constant name = "DeFi Reward Token";
    ...
    function mint(uint256 amount) external {
        ...
        require(
            ...
            "Would exceed max mint per address (100,000 DRT)"
        );
